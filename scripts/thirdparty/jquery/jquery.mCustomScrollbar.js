			...
			return this.each(function(){
				...
				if(options.scrollButtons.enable){
					if(options.horizontalScroll){
						...
						mCSB_scrollTools.prepend("<a class='mCSB_buttonUp' oncontextmenu='return false;'><i class='icon-angle-up'></i></a>").append("<a class='mCSB_buttonDown' oncontextmenu='return false;'><i class='icon-angle-down'></i></a>");
					}
				}
